                  ...
                  <div className="mt-64">
                    ...
                    >
                      <a href={project?.siteLink} target='_blank' rel="noreferrer">
                        <button className='text-white   border px-3 py-2 rounded-md border-[#4162f5] hover:border-transparent hover:bg-[#05114677]'>
                          View Live Site
                        </button>
                      </a>
                      <Link to={`/project/${project?.id}`} >
                        <button className='text-white px-3 border  py-2 rounded-md border-[#4162f5] hover:border-transparent hover:bg-[#05114677]'>
                          View More Details
                        </button>
                      </Link>
                    </div>
