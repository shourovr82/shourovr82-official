...
const About = () => {
  return (
    <div className='w-11/12 md:w-10/12 mx-auto'>
      ...
      <div className='md:grid grid-cols-2' id='about'>
        <div>
          <h1 className='text-[#717c99] font-semibold text-lg '>Hello! My name is Shafinur Islam and I enjoy creating Website | Web Apps that live on the internet. My interest in web development started back in 2018.
            <br />
            <br />
            Contact Me  : <br />
