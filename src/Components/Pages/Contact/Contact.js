    ...
    <div className='mt-10'>
      ...
      <div >
        ...
        <div className='flex justify-center'>
          ...
          <form
            onSubmit={sendEmail}
            className='flex flex-col w-3/5 p-10 justify-center ml-16 gap-10 '>
            <input type="text" className='py-4 text-[#cca79a] pl-3 placeholder:text-xl  text-xl  bg-transparent border-b border-[#c602a891]' name="name" id="name" placeholder='Please Enter Your Name' />
            <input type="email" className='py-2 text-[#cca79a] text-xl pl-3 placeholder:text-xl  bg-transparent border-b  border-[#c602a891] ' name="email" id="" placeholder='Please Enter Your Email' />
            <textarea className="textarea py-10 text-xl text-[#cca79a] pl-3 bg-transparent placeholder:text-2xl textarea-[#c602a891] mt-2 rounded-0 textarea-about" name='message' placeholder="Message"></textarea>
